...
function onhover(a) {
  if (a == 0){
      var c = document.getElementById("demohome0").children;
  }
  if (a == 1){
      var c = document.getElementById("demohome1").children;
  }
  if (a == 2){
      var c = document.getElementById("demohome2").children;
  }
  if (a == 3){
      var c = document.getElementById("demohome3").children;
  }
  if (a == 4){
  var c = document.getElementById("demohome4").children;
  }
  if (a == 5){
  var c = document.getElementById("demohome5").children;
  }
  c[1].style.zIndex=1;
  c[1].style.opacity=1;
  c[0].style.opacity=-1;
